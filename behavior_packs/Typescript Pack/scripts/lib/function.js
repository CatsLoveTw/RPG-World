    ...
    getPlayerLevel (player) {
        ...
        class te {
            constructor() {
                this.level = l['level']
                this.xp = l['xp']
                this.needxp = l['needxp']
                this.name = l['name']
                this.maxlevel = l['maxlevel']
            }
        }
        return new te()
    }
...
export { isNum, randomInt, getScore, worldlog, worldDB }